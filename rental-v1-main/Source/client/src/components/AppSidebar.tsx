...
const AppSidebar = ({userType}: AppSidebarProps) => {
    ...
    const navLinks = userType === "manage" ? [
        {icon: Building, label: "Properties", href: "/managers/properties"},
        {icon: Building, label: "Applications", href: "/managers/applications"},
        {icon: Building, label: "Settings", href: "/managers/settings"}
    ] : [
        {icon: Building, label: "Favorites", href: "/tenants/favorites"},
        {icon: Building, label: "Applications", href: "/tenants/applications"},
        {icon: Building, label: "Residences", href: "/tenants/residences"},
        {icon: Building, label: "Settings", href: "/tenants/settings"}
    ]
    return (
        <Sidebar
            collapsible='icon'
            ...
            style={{
                ...
                height: `calc(180vh - ${NAVBAR_HEIGHT}px)`
            }}
        >
            <SidebarHeader>
                <SidebarMenu>

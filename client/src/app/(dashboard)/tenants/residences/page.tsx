  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {currentResidences?.properties.map((property: Property) => (
          <Card
            key={property.id}
            property={property}
            isFavorite={tenant?.favorites?.some(fav => fav === property.id) || false}
            onFavoriteToggle={() => {}}
      ...
      {(!currentResidences || currentResidences.properties.length === 0) && (

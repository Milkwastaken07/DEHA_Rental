# Generated by Django 5.2 on 2025-05-20 17:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lease', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.lease')),
            ],
            options={
                'db_table': 'Payment',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locationId', models.ForeignKey(db_column='locationId', on_delete=django.db.models.deletion.CASCADE, to='apps.location')),
                ('managerCognitoId', models.ForeignKey(db_column='managerCognitoId', on_delete=django.db.models.deletion.CASCADE, to='apps.manager', to_field='cognitoId')),
                ('favoritedBy', models.ManyToManyField(blank=True, related_name='favorites', to='apps.tenant')),
                ('tenants', models.ManyToManyField(blank=True, related_name='properties', to='apps.tenant')),
            ],
            options={
                'db_table': 'Property',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leaseId', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='apps.lease')),
                ('propertyId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.property')),
            ],
            options={
